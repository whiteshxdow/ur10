...
def main():
    ...
    arm = MyRobot("full_arm")
    #hand =  MyRobot("hand")
    
    #call the function to set the position to "stand_pose"
    ...
    #Here, we will repeat the cycle of setting to various targets, simulating the pose loop
